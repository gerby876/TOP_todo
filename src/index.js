...
import {updateStorage, useStorage} from "./local.js"
...
const firstLoad = (function() {
    ...
    if (myProjects == "") {
        const test = new project ("Test Project", "Test Project Description", "yyyy-mm-dd", "high");
        const testtask = new task ("Test Task", "yyyy-mm-dd", "mid", "no");
        test.tasks.push(testtask);
        myProjects.push(test);
